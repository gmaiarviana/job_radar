# Career Narrative — Guilherme Maia

**Purpose:** Strategic document that defines positioning, narrative arc, and evidence base for resume, LinkedIn, and job applications.
**Language:** English (base). Portuguese version to be derived.
**Status:** Draft v1 — pending review and validation of specific items.
...
### One-liner
Program & Product Manager with hands-on experience in data analysis and AI experimentation, who bridges strategy and execution — from diagnosing problems and defining solutions to coordinating delivery across global, multi-team programs.

### Target titles (job search)
- Product Manager (preferred)
- Technical Program Manager (strongest evidence)
- Hybrid roles: Product Manager with technical focus, Program Manager with product mindset

### Salary target
- Minimum: $5,500 USD/month
- Preferred: $6,000+ USD/month
- Remote, international companies

### Working language
- **English:** Professional fluency. 3+ years working daily with American stakeholders. 1-year university exchange in the US. Top score in internal English assessment.
- **Portuguese:** Native.
...
### Act 1 — Managing Physical Complexity (Construction, 2016–2019)

**VM Engenharia** (internship, Sep/2013 – Apr/2014): Infrastructure projects intern at a construction company with strong industrial/process culture (standardized housing, internal audits, quality control documentation). Supported compatibility analysis of infrastructure projects (water, sewage, roads), created executive-level drawings from base projects, calculated material quantities, and composed unit cost spreadsheets for standard housing units. Participated in franchise consulting process that required structuring all roles and responsibilities.
...
Core responsibilities: Execution planning, scheduling, material procurement, budget composition, methodology selection, contractor management, project compatibility analysis (architectural, structural, electrical), risk management with weekly board presentations, workforce training, regulatory approvals.

> **Why it matters:** Demonstrates operational leadership at scale, people management with real authority, rapid professional growth driven by initiative and availability, and the ability to manage complexity before entering tech.

**Transition trigger:** Recognized that the construction industry had limited room for innovation and professional growth. Decided to migrate to technology to work with modern tools and higher-impact problems.

---

### Act 2 — Building Analytical & Product Skills (Tech, 2020–2024)
...
- Participated in documentation task force to centralize squad knowledge on Confluence
- Developed systematic approach to data storytelling: lead with conclusion, then supporting evidence — learned from team book club reading "The Signal and the Noise"
- Created visualizations with Python (Seaborn, Plotly, Altair) with clear headlines, minimal text, attention-directing arrows, and pause-and-check cadence during weekly presentations

**Instituto Atlântico — Product Owner** (Jul/2022 – Sep/2024): Evolved from understanding the business to reshaping how teams worked. Joined a program where teams lacked clarity on scope, priorities, product vision, and responsibilities — a common symptom of component-oriented teams where no one owns the end-to-end product.
...
- Contributed to innovation pipeline design: Volunteered with Instituto Atlântico's Innovation Department, proposed restructuring of the internal innovation pipeline — merging two existing tracks and introducing a shared diagnostic stage as a unified entry point. Contributed to the organizational design of the StageGate framework adopted by the department.
...
**Instituto Atlântico — Project Manager** (Oct/2025 – Present): Initially managed a 4-startup program (300h development allocation per startup, venture capital partnership model), then transitioned to managing 2 teams (8 people) for an electronics client. Current role with focus on people management, process guardianship, and stakeholder alignment.

Additional current activities:
- Volunteered as Product Manager for Area 51 (internal projects department) — defining MVPs, scoping PoCs, prioritizing internal integration requests
- Leading R&D initiative (2026): Coordinating a team of 4 engineers on an experiment to produce a research article — designed structure, created evaluation criteria and questionnaire for AI accuracy validation
- Created PDI Guide (Individual Development Plan) for direct reports — including recommendations, frameworks, and a custom Gemini assistant to help employees elaborate their development plans

---

## 3. Pillars of Competence

### Pillar 1: Product Management
- Defined product vision, built roadmaps, prioritized backlogs aligned with OKRs
- Led refinement sessions with engineering, UX, and architecture teams
...
- **Evidence:** TPM coordinating 25 engineers (program of 200+); Project Manager of 15-story building with 40 direct reports

### Pillar 3: Data Analysis & Evidence-Based Decision Making
- ETL data extraction and manipulation (Apache Spark/Scala, Databricks)
- Data cleaning, dataset creation, exploratory analysis, data drift investigation
- Pipeline optimization (moved processing from notebooks to ETL layer)
...
- Bilingual professional operation (English/Portuguese) with American clients for 3+ years
- Facilitates alignment across disciplines (UX, engineering, architecture, business)
- Data storytelling methodology: headline → context → visual → check-in → discussion
- **Evidence:** Present in every role — from construction stakeholders to Nubank data presentations to global program coordination
...
| Result | Context |
|--------|---------|
| Reorganized teams component → product, reducing delivery cycle from ~3 sprints to ~1 sprint | Instituto Atlântico, PO |
...
| Managed ~40 direct reports (hiring, firing, payroll) | Campos Gouveia, PM |
| Temporarily managed 2 construction sites simultaneously (~2 months) | Campos Gouveia, PM |
| Promoted from intern to lead engineer in ~1.5 years | Campos Gouveia (growth trajectory) |
| Interviewed 10 teams to diagnose program-level risks | Instituto Atlântico, PO (internal initiative) |

---

## 5. Differentiators

1. **Bridges strategy and execution.** Most PMs stay strategic; most TPMs stay operational. Guilherme does both — defines the "what" and ensures the "how" gets done.
2. **Hands-on with AI.** Doesn't just talk about AI — builds tools, writes prompts, deploys services, runs experiments. Can go from idea to working prototype.
3. **Construction-to-tech career arc.** Went from intern to lead engineer in 1.5 years, managed 40 people and a 15-story building before age 25. Brings operational leadership maturity that most tech PMs lack.
4. **Bilingual, battle-tested in global teams.** 3+ years daily with American stakeholders, 1-year US exchange. Comfortable leading ceremonies, presentations, and negotiations in English.
5. **Systematic thinker.** Approaches problems from first principles — why is this a problem, why now, what changed. Documented in how he structures PoCs, reorganizes teams, and designs AI systems.
6. **Initiative pattern.** Consistently proposes and drives initiatives beyond assigned scope — PO guild, innovation pipeline, Area 51, R&D, GenAI PoCs. Does not wait for permission to add value.
...
|-------|-------------|-------------|
| Philosophy / first principles thinking | Sounds abstract without context | Companies with "thinking" culture, interview conversations |
| CEO ambition | May signal flight risk | Startup founder roles, entrepreneurship programs |
| Environmental regeneration / new economy | Narrows the funnel | Green tech, climate tech, agritech, social impact companies |
| "Technology for social good" | Generic | Companies with explicit social mission |
| Frustrations with current employer | Never | Never |
| Paper Agent deep dive | May seem overweight for personal project | Roles requiring AI architecture, technical PM roles — position as "applied learning project" |
| Criticism of past employers/structures | Never on resume | Only in interviews if directly asked, framed constructively |
...
**Summary (3 lines):** Adapted per application from this narrative document.

**Experience:**
- Project Manager | Instituto Atlântico | Oct/2025 – Present (brief, current role)
- Technical Program Manager | Instituto Atlântico | Sep/2024 – Sep/2025 (strong TPM bullets)
- Product Owner | Instituto Atlântico | Jul/2022 – Sep/2024 (strongest section — product + AI)
- Business Analyst | Nubank | Feb/2021 – May/2022 (data + evidence-based decisions)
- RPA Analyst | Accenture | Oct/2020 – Jan/2021 (1 line — career transition bridge)
- Project Manager | Campos Gouveia | Apr/2018 – Dec/2019 (leadership + scale, 2-3 bullets)
- Analyst | Campos Gouveia | Jul/2017 – Mar/2018 (optional — can merge with PM role above)
- Intern | Campos Gouveia | Jul/2016 – Jun/2017 (optional — growth story for interviews, may omit from resume)
- Intern | VM Engenharia | Sep/2013 – Apr/2014 (optional — omit from resume, use as interview context)
...
- B.S. Civil Engineering | Universidade de Pernambuco | 2017
- CAPM (PMI)
- Google Cloud Generative AI Leader
- 1-year university exchange in the US

---

*Document version: v1 — Feb 2026*
*Next steps: Review, validate pending items, record Nubank/Construction audios, then build resume.*
